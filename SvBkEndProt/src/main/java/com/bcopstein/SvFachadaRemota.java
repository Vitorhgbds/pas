...
public class SvFachadaRemota {
  ...
  public SvFachadaRemota() {
    ...
    produtos.add(new Produto(10, "Geladeira", 2500, 10.0));
    produtos.add(new Produto(20, "Fogao", 1200, 0.0));
    produtos.add(new Produto(30, "Lava louça", 4300, 7.0));
    produtos.add(new Produto(40, "Lava roupa", 3350, 11.0));
    produtos.add(new Produto(50, "Aspirador de pó", 780, 22.0));
